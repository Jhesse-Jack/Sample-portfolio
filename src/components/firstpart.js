    ...
    <div className="container">
      <div id="introduction" className=" firsttest">
        ...
        <div className="nexttest align-items-center">
          <h1 className="styledheaders">
            {" "}
            Hi, <span className="myfont"> I'm JAMES ARMAH </span>
          </h1>
          <h3 className="styledheaders">
            {" "}
            An <span> AGILE DEV OPS GUIDE </span> &amp;{" "}
          </h3>
          <h5 className="styledheaders">
            {" "}
            A <span className="faviconfont"> Front End Developer </span>
          </h5>
        </div>
        <br />
        <div className="socialmediaicos">
          <a href="https://github.com/Jhesse-Jack">
            {" "}
            <GoMarkGithub className="mediaicos" />{" "}
          </a>{" "}
          &nbsp; &nbsp; &nbsp;
          ...
          &nbsp; &nbsp; &nbsp;
          <a href="https://twitter.com/KC_Jesse_">
            <FaTwitter />
          </a>{" "}
          &nbsp; &nbsp; &nbsp;
        </div>
